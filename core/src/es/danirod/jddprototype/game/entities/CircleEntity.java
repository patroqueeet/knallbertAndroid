...
/**
 * This is the actor that will make you lose if you touch it. Circles are on the screen and you
...
public class CircleEntity extends Actor {
    ...
    /** The world this circle is in. */
    private World world;

    /** The body assigned to this circle. */
    private Body body;

    /** The fixture assigned to this circle. */
     ...
     * @param world
     * @param texture
     * @param x  horizontal position for the center of the circle (meters)
     * @param y  vertical position for the base of the circle(meters)
     */
    public CircleEntity(World world, Texture texture, float x, float y) {
        this.world = world;
        ...
        fixture.setUserData("circle");               // (6) And set the user data to enemy.
